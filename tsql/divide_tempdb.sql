...
BEGIN
	...
	SELECT @physical_name = REPLACE(physical_name, REVERSE(SUBSTRING(REVERSE(physical_name), 1, CHARINDEX('\', REVERSE(physical_name)) - 1)), '')
...
END
ELSE
	RAISERROR ('O tempdb j? possui mais que 2 arquivos, analise e crie manualmente', 10, 1)