...
--SCRIPT QUE TESTA MERGE! NÃO RODA TUDO! VAI COM CALMA, CAMPEÃO!
...
--INICIALMENTE RODA ATÉ AQUI. VEJA QUE AS TABELAS ESTÃO DIFERENTES
--A TABELA PRODUCTS VAI SER ATUALIZADA COM O QUE TÁ NA UPDATEDPRODUCTS
--AQUI EMBAIXO QUE A MÁGICA ACONTECE
